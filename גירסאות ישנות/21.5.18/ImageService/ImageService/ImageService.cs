...
namespace ImageService
{
    ...
    public partial class ImageService : ServiceBase
    {
        ...
        public ImageService(string[] args)
        {
            ...
            IClientHandler ch = new ClientHandler(new ServerController(m_logging), this.m_logging);
            tcpServer = new MultyServer(8005, ch);
        ...
        protected override void OnStart(string[] args)
        {
            ...
            server.CommandRecieved += tcpServer.SendAllClientCommand;
